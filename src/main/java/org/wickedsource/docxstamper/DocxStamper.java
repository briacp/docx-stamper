...
public class DocxStamper<T> {
  ...
  private void initFields() {
    ...
    commentProcessorRegistry.registerCommentProcessor(IRepeatProcessor.class, new RepeatProcessor(typeResolverRegistry, config.getLineBreakPlaceholder(), expressionResolver));
